MobileUO
=================================
Copyright (C) 2020-2026 Yilmaz Kiymaz (VoxelBoy), Bryan Denny (mandlar)

MobileUO is free software: you can redistribute it and/or modify
it under the terms of version 3 of the GNU Affero General Public
License (AGPLv3), as published by the Free Software Foundation.

This project contains code derived from the ClassicUO project,
which is licensed under the BSD 2-Clause License.

Files originating from ClassicUO remain licensed under the
