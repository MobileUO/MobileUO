...
namespace ClassicUO.Game.Managers
{
    internal class BandageManager : IDisposable
    {
        ...
        private bool ShouldAttemptHeal(Mobile mobile)
        {
            ...
            // MobileUO: TODO: TazUO re-visit after FriendsListManager is re-added
        ...
        private void ExecuteHealMobile(Mobile mobile)
        {
            ...
            if (UseNewBandagePacket)
            {
                ...
                // MobileUO: TODO: TazUo - async
                NetClient.Socket.Send_TargetSelectedObject(bandage.Serial, mobile.Serial);
