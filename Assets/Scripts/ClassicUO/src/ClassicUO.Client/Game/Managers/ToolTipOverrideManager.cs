...
namespace ClassicUO.Game.Managers
{
    ...
    public class ToolTipOverrideData
    {
        ...
        public static void ExportOverrideSettings(World world)
        {
            ...
            UIManager.Add(new FileSelector(World.Instance, FileSelectorType.Directory, Environment.GetFolderPath(Environment.SpecialFolder.Desktop), new string[] { "*.json" }, /*["*.json"],*/ (p) =>
            {
        ...
        {
            // MobileUO: collection expressions are not available in Unity's C#
            UIManager.Add(new FileSelector(World.Instance, FileSelectorType.File, Environment.GetFolderPath(Environment.SpecialFolder.Desktop), new string[] { "*.json" }, /*["*.json"],*/ (p) =>
            {
                if (!File.Exists(p))
                {
