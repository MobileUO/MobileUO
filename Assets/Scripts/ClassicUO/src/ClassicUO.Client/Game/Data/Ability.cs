...
namespace ClassicUO.Game.Data
{
    ...
    // MobileUO: record structs are not available in Unity's C#
    ...
    internal readonly struct ItemAbilities
    {
        public ushort Graphic { get; }
        public Ability First { get; }
        public Ability Second { get; }

        public ItemAbilities(ushort graphic, Ability first, Ability second)
        {
            Graphic = graphic;
            First = first;
            Second = second;
